...
class ProfilesTest < ApplicationSystemTestCase
  ...
  test "should create profile" do
    ...
    fill_in "Advice", with: @profile.advice
    fill_in "Hours", with: @profile.hours
    fill_in "How", with: @profile.how
    fill_in "Name", with: @profile.name
    fill_in "Title", with: @profile.title
    fill_in "User", with: @profile.user_id
    fill_in "What", with: @profile.what
    fill_in "Why", with: @profile.why
