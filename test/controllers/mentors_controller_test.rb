...
class MentorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mentor" do
    assert_difference("Mentor.count") do
      post mentors_url, params: { mentor: { email: @mentor.email, first_name: @mentor.first_name, last_name: @mentor.last_name, number: @mentor.number, occupation: @mentor.occupation } }
    end
  ...
  test "should update mentor" do
    patch mentor_url(@mentor), params: { mentor: { email: @mentor.email, first_name: @mentor.first_name, last_name: @mentor.last_name, number: @mentor.number, occupation: @mentor.occupation } }
