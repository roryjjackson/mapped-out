...
file1 = URI.open("https://res.cloudinary.com/dfipoufmj/image/upload/v1684773858/development/4fm99x9xxfh29676ntp8yhy5qtef.jpg")
user1.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
user1.user = user1
user1.save!

file2 = URI.open("https://res.cloudinary.com/dfipoufmj/image/upload/v1684771374/development/ewmzk2asaw84ezpkdaikkv65oca2.jpg")
user2.photo.attach(io: file2, filename: "nes.png", content_type: "image/png")
user2.user = user2
user2.save!

file3 = URI.open("https://res.cloudinary.com/dfipoufmj/image/upload/v1684770362/development/2rg7l62zpjri0g5vzc2utnr3re1n.jpg")
