class Questionnaire < ApplicationRecord
  ...
  def self.all_questions
    [
      ...
      "I believe time is too preciosu to be wasted by being disorganized",
      ...
      "I get excited when alayzing and dealing with numbers",
      "It is natural for me to quickly adjust to changing circumstances",
      "It is natural for me to voice my opinion, even if it contrary to others",
